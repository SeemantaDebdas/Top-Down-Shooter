...
namespace TDS
{
    public class MeleeEnemyMove : EnemyState
    {
        Transform waypoint;
        public MeleeEnemyMove(Enemy enemy, EnemyStatemachine statemachine, string animation) : base(enemy, statemachine, animation)
        {
        ...
        public override void Update()
        {
            ...
            if (remainingDistance < 0.1f)
                statemachine.SwitchState((enemy as MeleeEnemy).IdleState);
        }
    }
}
